package social.app.apps.backoffice.backend.middleware;

import social.app.backoffice.auth.application.authenticate.AuthenticateUserCommand;
...
public final class BasicHttpAuthMiddleware implements Filter {
    ...
    private void askForCredentials(ServletResponse response) {
        ...
        httpServletResponse.setHeader("WWW-Authenticate", "Basic realm=\"SocialApp\"");
    }
}
