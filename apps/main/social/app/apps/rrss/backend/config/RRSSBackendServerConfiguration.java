...
import social.app.shared.infrastructure.spring.ApiExceptionMiddleware;

@Configuration
public class RRSSBackendServerConfiguration {
    private final RequestMappingHandlerMapping mapping;

    public RRSSBackendServerConfiguration(RequestMappingHandlerMapping mapping) {
